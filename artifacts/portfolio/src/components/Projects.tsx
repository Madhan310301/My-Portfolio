...
const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    desc: "Automated micro-investment and emergency safety-net prototype for gig drivers (RideGo Captains), featuring auto-save trip pace sliders, spare-change roundups, a Two-Pockets architecture (Emergency Cushion & Growth), and an interactive trip simulator.",
    duration: "Completed 2026",
    stack: ["React", "TypeScript", "Vite", "Tailwind CSS", "Radix UI", "Context API"],
    fullDesc1: "GigSave is an automated micro-investment platform specifically architected for gig-economy delivery partners and ride-hailing drivers. It automatically diverts a customizable 2% to 5% pace from daily trip payouts alongside spare-change round-up deductions into compounding financial cushions without disrupting daily operational cashflow.",
    fullDesc2: "Features a strict Two-Pockets financial model: 100% of micro-savings fund an instant-access ₹2,000 Emergency Cushion before flowing into long-term equity Growth pockets. Includes 3 personalized risk profiles, gamified achievement streaks, a consistency-based Trust Score, and a live Interactive Trip Simulator for testing deduction flows.",
    milestone: "Complete end-to-end prototype featuring 3-step onboarding, Two-Pockets vault, and live trip simulator.",
