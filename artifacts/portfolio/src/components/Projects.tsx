...
const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    desc: "This portfolio — a cinematic dark-theme site with animated skills visualizer, 22-project navigator, education flight trajectory, and interactive contact form.",
    duration: "Ongoing 2026",
    stack: ["React", "Vite", "TypeScript", "Framer Motion", "Recharts", "Tailwind CSS"],
    fullDesc1: "This very site — built as a cinematic, dark-space themed portfolio to showcase 22+ projects, skills, credentials, and the complete engineering journey from SSLC to B.Tech. Every section is a custom-designed interactive experience.",
    fullDesc2: "Features include a Recharts skills visualizer (Bar/Donut/Spider tabs), a 22-project orbit navigator with scoped scroll/keyboard/swipe navigation, an education flight trajectory with Framer Motion rocket animation, and a Nebula particle background.",
    milestone: "Full cinematic portfolio with 7 interactive sections live and deployed.",
    keyFeature: "Recharts skills visualizer, Framer Motion education trajectory, 22-project case-study navigator.",
