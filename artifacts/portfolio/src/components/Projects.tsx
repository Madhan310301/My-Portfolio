...
const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    desc: "This portfolio — a cinematic dark-theme site with animated skills visualizer, 27-project navigator, education flight trajectory, and interactive contact form.",
    duration: "Ongoing 2026",
    stack: ["React", "Vite", "TypeScript", "Framer Motion", "Recharts", "Tailwind CSS"],
    fullDesc1: "This very site — built as a cinematic, dark-space themed portfolio to showcase 25+ projects shipped successfully, skills, credentials, and the complete engineering journey from SSLC to B.Tech. Every section is a custom-designed interactive experience.",
    fullDesc2: "Features include a Recharts skills visualizer (Bar/Donut/Spider tabs), an interactive project orbit navigator with scoped scroll/keyboard/swipe navigation, an education flight trajectory with Framer Motion rocket animation, and a Nebula particle background.",
    milestone: "Full cinematic portfolio with 7 interactive sections live and deployed.",
    keyFeature: "Recharts skills visualizer, Framer Motion education trajectory, 25+ projects case-study navigator.",
  ...
  },
  {
    ...
    tag: "[BUILD-22]",
    title: "CrashGuard-AI",
    category: "IoT Crash & Hazard Detection System",
    desc: "Offline-first IoT crash detection and emergency rescue dispatch platform (ESP32-C3 + Arduino Mega) with multi-sensor crash verification, post-collision hazard sensing, SIM800L GSM SMS alerts, and a Supabase Realtime control room dashboard.",
    duration: "Completed 2026",
    stack: ["ESP32-C3", "Arduino Mega", "Supabase", "React", "TypeScript", "Tailwind CSS", "GSM SIM800L", "MPU6050", "NEO-6M GPS"],
    fullDesc1: "CrashGuard-AI is an offline-first, IoT-powered emergency crash detection and hazard monitoring platform engineered for high-speed two-wheelers and automotive safety. Multi-sensor fusion (MPU6050 6-DOF, MQ Gas/Smoke, DHT11 Climate, Acoustic Mic, NEO-6M GPS) detects collisions in real-time and validates post-crash environmental hazards.",
    fullDesc2: "Operating on an offline-first safety principle, emergency SOS alerts dispatch over always-on SIM800L GSM SMS even when cellular data or WiFi is offline at crash sites. A 10-second rider cancel window prevents false alarms. When online, telemetry streams over WebSockets to a Supabase-backed React control room dashboard with live Leaflet GPS tracking and real-time hazard analytics.",
    milestone: "Built for Coimbatore Innovation Hackathon 2026 (CIH '26) by Team Code Nest ('Detect. Assess. Escalate. Save Lives.').",
    keyFeature: "Offline-first SIM800L GSM emergency SMS dispatcher + 10s cancel window + Supabase Realtime control room dashboard.",
    problem: "1.19M global road crash deaths annually — victims often unconscious, without bystander reporting, accurate GPS coordinates, or scene hazard info.",
    challenge: "Guaranteeing sub-second multi-sensor crash validation (G-force > 4.0g, tilt > 65°, acoustic spike) without false triggers while managing dual GSM/Cloud telemetry dispatch.",
    github: "https://github.com/Madhan310301/CrashGaurdAI",
  },
  {
    id: 23,
    slug: "triagecn",
    tag: "[BUILD-23]",
    title: "TriageCN",
    category: "Offline Vulnerability Triage Cockpit",
    desc: "100% client-side, zero-backend CVE triage cockpit fusing technical severity (CVSS), real-world exploitation signals (CISA KEV), likelihood (EPSS), asset exposure, and exact software inventory version ranges into an actionable Top 5 Remediation Queue.",
    duration: "Completed 2026",
    stack: ["TypeScript", "React", "Node.js", "Tailwind CSS", "Offline-First", "Vite"],
    fullDesc1: "TriageCN is a zero-backend, zero-network vulnerability triage cockpit engineered to eliminate security alert fatigue. Instead of ranking hundreds of CVEs by naive CVSS scores alone, it matches 540 bundled CVE records against 6 distinct organizational technology inventories using a deterministic three-layer decision funnel.",
    fullDesc2: "The scoring engine synthesizes normalized CVSS, binary CISA KEV exploitation flags, FIRST EPSS probabilities, exposure bonuses (internet-facing vs. internal), and criticality weights, applying confidence penalties for unverified versions. Built for the Nexora 2k26 Hackathon, it delivers an auditable Top 5 Actionable Remediation Queue with zero external API calls.",
    milestone: "Built for Nexora 2k26 Hackathon — 100% offline triage engine over 540 CVEs and 6 organizational risk profiles.",
    keyFeature: "Deterministic 3-layer matching funnel (Alias, Exact/Semver, Dice Fuzzy) + multi-signal priority scoring formula.",
    problem: "Security teams drown in hundreds of CVE alerts ranked naively by CVSS alone, most of which are completely irrelevant to their deployed stack.",
    challenge: "Executing semantic version boundary matching and fuzzy alias normalization purely client-side without runtime network dependencies.",
    github: "https://github.com/Madhan310301/TriageCN",
  },
  {
    id: 24,
    ...
    category: "Automated Certificate Issuance Platform",
    desc: "High-speed certificate generation and verification platform for Google Student Ambassadors (GSA) & Freshers Fuse at BIHER, featuring HTML5 Canvas dynamic name rendering, live preview, and instant high-res export.",
    duration: "Completed 2026",
    stack: ["React", "TypeScript", "Vite", "HTML5 Canvas", "Tailwind CSS", "Lucide React"],
    fullDesc1: "Certificate Generator is an automated event credentialing platform built for the Google Freshers Fuse community initiative at BIHER. It allows student participants to look up their records, preview customized participation certificates with pixel-perfect typography, and export high-resolution assets instantly.",
    fullDesc2: "Powered by an optimized HTML5 Canvas rendering pipeline, the system injects dynamic attendee names, verification badges, and timestamps over calibrated template coordinates with custom web fonts. It features responsive preview scaling, fallback rendering safeguards, and client-side high-DPI image download triggers.",
    milestone: "Official automated certificate distribution system for Google Freshers Fuse event at BIHER.",
    keyFeature: "Sub-second HTML5 Canvas high-DPI certificate generation + dynamic name coordinate calibration.",
    problem: "Manually creating, verifying, and distributing hundreds of personalized event certificates creates administrative bottlenecks and formatting errors.",
    challenge: "Maintaining typography alignment, font weight rendering, and high-DPI print clarity across mobile and desktop canvas contexts.",
    github: "https://github.com/Madhan310301/Certificate_Generator",
    liveDemo: "https://google-freshers-fuse.vercel.app",
  },
  {
    id: 25,
    slug: "gigsave",
    tag: "[BUILD-25]",
    title: "GigSave",
    category: "Gig-Economy Micro-Investment Platform",
    desc: "Automated micro-investment and emergency safety-net prototype for gig drivers (RideGo Captains) — concept & product idea by Lakshita, interactive prototype engineered by Madhan Kumar — featuring auto-save sliders, Two-Pockets architecture, and a live trip simulator.",
    duration: "Completed 2026",
    stack: ["React", "TypeScript", "Vite", "Tailwind CSS", "Radix UI", "Context API"],
    fullDesc1: "GigSave is an automated micro-investment prototype designed for gig-economy delivery partners and ride-hailing drivers (RideGo Captains). The core problem framing and product concept were conceived by my junior, Lakshita, while the full interactive technical prototype, component architecture, state engine, and live simulation workflows were engineered by me.",
    fullDesc2: "Features a strict Two-Pockets financial model: 100% of micro-savings (2%–5% trip pace + spare change roundups) fund an instant-access ₹2,000 Emergency Cushion before auto-diverting into compounding equity Growth pockets. Includes 3 personalized risk profiles, gamified achievement streaks, a consistency-based Trust Score, and a live Interactive Trip Simulator for testing deduction flows.",
    milestone: "Interactive prototype engineered by Madhan Kumar based on the original product concept conceived by Lakshita.",
    keyFeature: "Two-Pockets architecture (₹2K Emergency Cushion auto-switch to Growth) + interactive trip deduction simulator.",
    problem: "Gig-economy workers face volatile daily earnings with zero institutional emergency safety nets, micro-investment tools, or automated retirement buffers.",
    challenge: "Simulating real-time trip earnings roundups and split-pocket balance transfers with seamless state persistence and instant celebration feedback.",
    github: "https://github.com/Madhan310301/GigSave",
  },
  {
    id: 26,
    slug: "dental-clinic-web",
    tag: "[BUILD-26]",
    title: "Shakthi Dental Clinic",
    category: "Healthcare Clinic & Staff Portal",
    desc: "Official production web portal for Shakthi Dental Clinic (Est. 2004) featuring 9 specialist doctor profiles, smart shift-based WhatsApp booking, a password-protected staff portal with login audit trails, and Supabase RLS database integration.",
    duration: "Completed 2026",
    stack: ["React", "TypeScript", "Tailwind CSS", "Vite", "Supabase", "PostgreSQL", "Wouter", "Framer Motion"],
    fullDesc1: "Shakthi Dental Clinic is a production-grade healthcare portal built for a clinic serving patients since 2004 in Hosur. It delivers an intuitive patient experience with 9 specialist doctor profiles (Orthodontics, Endodontics, Implants, Laser Surgery) and a multi-preference appointment scheduler with automated WhatsApp routing.",
    fullDesc2: "A password-protected Hospital Staff Portal (/staff-portal) gives clinic administrators a centralized management console with color-coded appointment statuses, one-click CSV/Excel export, and DPDP-compliant compliance audit trails logging every staff access event into Supabase PostgreSQL with Row Level Security.",
    milestone: "Production healthcare application serving real patient appointment workflows and administrative audit logging.",
    keyFeature: "Smart shift-preference WhatsApp booking system + password-protected Staff Portal with CSV exports and access audit logs.",
    problem: "Local clinics struggle with fragmented phone-call appointment tracking, lack of specialist scheduling transparency, and unlogged patient record management.",
    challenge: "Architecting a dual-interface system balancing zero-friction public patient booking with strict DPDP-compliant authenticated administrative audit logging.",
    github: "https://github.com/Madhan310301/DentalClinicWeb",
    liveDemo: "https://shakthidentalclinic.in",
  },
  {
    id: 27,
    slug: "quantarag",
