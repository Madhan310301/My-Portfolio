          ...
          >
            {NAV_LINKS.map((link) => (
              <a
                ...
                href={link.href}
                onClick={(e) => scrollTo(e, link.href)}
                className="text-base font-medium text-[#7A6B55] hover:text-[#C9972E] py-3 min-h-[44px] flex items-center border-b border-[#C9972E]/10 transition-colors last:border-0"
              >
                {link.label}
              </a>
            ))}
            <div className="flex flex-col gap-2 mt-2 pt-2 border-t border-[#C9972E]/15">
              <HireMeButton className="w-full min-h-[44px] py-3 text-center text-sm font-bold bg-gradient-to-r from-[#D9A94A] to-[#B9821F] text-white rounded-lg flex items-center justify-center" />
              <a
                href="/resume.pdf"
                target="_blank"
                rel="noopener noreferrer"
                className="w-full min-h-[44px] py-3 text-center text-sm font-bold bg-gradient-to-r from-[#D9A94A] to-[#B9821F] text-white rounded-lg flex items-center justify-center"
              >
                View Resume
              </a>
            </div>
