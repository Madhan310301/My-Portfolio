      ...
      <div className="container mx-auto max-w-4xl relative z-10">
        ...
        >
          <div className="mb-10 border-b border-[#C9972E]/20 pb-6">
            ...
            <h1 className="text-3xl md:text-5xl font-display font-bold text-[#241B10] mb-4">Privacy Policy</h1>
          ...
          <div className="max-w-none text-[#7A6B55] text-sm md:text-base leading-relaxed space-y-8 font-sans">
            ...
            <section className="space-y-3">
              <h2 className="text-xl font-bold text-[#241B10] font-display flex items-center gap-2">
                <span className="text-[#C9972E] font-mono text-sm">// 01</span> Information I Collect
              </h2>
              <p>
            ...
            <section className="space-y-3">
              <h2 className="text-xl font-bold text-[#241B10] font-display flex items-center gap-2">
                <span className="text-[#C9972E] font-mono text-sm">// 02</span> How I Use Your Information
              </h2>
              <p>
            ...
            <section className="space-y-3">
              <h2 className="text-xl font-bold text-[#241B10] font-display flex items-center gap-2">
                <span className="text-[#C9972E] font-mono text-sm">// 03</span> Third-Party Services
              </h2>
              <p>
            ...
            <section className="space-y-3">
              <h2 className="text-xl font-bold text-[#241B10] font-display flex items-center gap-2">
                <span className="text-[#C9972E] font-mono text-sm">// 04</span> Data Retention
              </h2>
              <p>
            ...
            <section className="space-y-3">
              <h2 className="text-xl font-bold text-[#241B10] font-display flex items-center gap-2">
                <span className="text-[#C9972E] font-mono text-sm">// 05</span> Your Rights
              </h2>
              <p>
                <span className="text-[#241B10] font-semibold">If you are in India:</span> Under the Digital Personal Data Protection Act, 2023 and IT Act, 2000 (including the SPDI Rules, 2011), you have the right to access, correct, or request deletion of your personal data, and to withdraw consent at any time.
              </p>
              <p>
                <span className="text-[#241B10] font-semibold">If you are in the United States:</span> Depending on your state of residence, you may have rights to know what personal information is collected, request its deletion, and opt out of its sale or sharing — this Site does not sell or share your information with third parties in any case.
              </p>
            </section>

            <section className="space-y-3">
              <h2 className="text-xl font-bold text-[#241B10] font-display flex items-center gap-2">
                <span className="text-[#C9972E] font-mono text-sm">// 06</span> Exercising Your Rights
              </h2>
              <p>
            ...
            <section className="space-y-3">
              <h2 className="text-xl font-bold text-[#241B10] font-display flex items-center gap-2">
                <span className="text-[#C9972E] font-mono text-sm">// 07</span> Security
              </h2>
              <p>
            ...
            <section className="space-y-3">
              <h2 className="text-xl font-bold text-[#241B10] font-display flex items-center gap-2">
                <span className="text-[#C9972E] font-mono text-sm">// 08</span> Children's Privacy
              </h2>
              <p>
            ...
            <section className="space-y-3">
              <h2 className="text-xl font-bold text-[#241B10] font-display flex items-center gap-2">
                <span className="text-[#C9972E] font-mono text-sm">// 09</span> Changes to This Policy
              </h2>
              <p>
            ...
            <section className="space-y-3">
              <h2 className="text-xl font-bold text-[#241B10] font-display flex items-center gap-2">
                <span className="text-[#C9972E] font-mono text-sm">// 10</span> Contact
              </h2>
              <p>
