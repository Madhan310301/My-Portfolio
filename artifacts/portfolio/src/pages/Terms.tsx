      ...
      <div className="container mx-auto max-w-4xl relative z-10">
        ...
        >
          <div className="mb-10 border-b border-white/10 pb-6">
            ...
            <h1 className="text-3xl md:text-5xl font-display font-bold text-white mb-4">Terms &amp; Conditions</h1>
          ...
          <div className="prose prose-invert max-w-none text-muted-foreground text-sm md:text-base leading-relaxed space-y-8 font-sans">
            <p>
              Welcome to <span className="text-white font-medium">madhan-developer.vercel.app</span> ("the Site"), owned and operated by Madhan Kumar T ("I", "me", "my"). By accessing or using this Site, you agree to these Terms &amp; Conditions.
            </p>

            <section className="space-y-3">
              <h2 className="text-xl font-bold text-white font-display flex items-center gap-2">
                <span className="text-primary font-mono text-sm">// 01</span> About This Site
              </h2>
              <p>
            ...
            <section className="space-y-3">
              <h2 className="text-xl font-bold text-white font-display flex items-center gap-2">
                <span className="text-primary font-mono text-sm">// 02</span> Intellectual Property
              </h2>
              <p>
            ...
            <section className="space-y-3">
              <h2 className="text-xl font-bold text-white font-display flex items-center gap-2">
                <span className="text-primary font-mono text-sm">// 03</span> Use of the Site
              </h2>
              <p>
            ...
            <section className="space-y-3">
              <h2 className="text-xl font-bold text-white font-display flex items-center gap-2">
                <span className="text-primary font-mono text-sm">// 04</span> Third-Party Links &amp; Services
              </h2>
              <p>
            ...
            <section className="space-y-3">
              <h2 className="text-xl font-bold text-white font-display flex items-center gap-2">
                <span className="text-primary font-mono text-sm">// 05</span> No Warranty
              </h2>
              <p>
            ...
            <section className="space-y-3">
              <h2 className="text-xl font-bold text-white font-display flex items-center gap-2">
                <span className="text-primary font-mono text-sm">// 07</span> Governing Law
              </h2>
              <p>
            ...
            <section className="space-y-3">
              <h2 className="text-xl font-bold text-white font-display flex items-center gap-2">
                <span className="text-primary font-mono text-sm">// 08</span> Changes to These Terms
              </h2>
              <p>
            ...
            <section className="space-y-3">
              <h2 className="text-xl font-bold text-white font-display flex items-center gap-2">
                <span className="text-primary font-mono text-sm">// 09</span> Contact
              </h2>
              <p>
